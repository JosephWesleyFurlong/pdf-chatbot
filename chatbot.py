...
# Set the OpenAI API key using Streamlit secrets (assuming you added it to secrets.toml)
...
def query_openai(conversation_history, first_query=False):
    try:
        ...
        # Send the request to OpenAI API using the new syntax
